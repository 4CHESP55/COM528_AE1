...
<%
    request.setAttribute("selectedPage", "cardReader");
    ...
    if ("submit".equals(submit)) {
        ...
        if (amount.startsWith("/")) {
            Double dAmount = Double.parseDouble(amount.substring(1));
            TransactionReplyMessage result = client.transferMoney(toCard, fromCard, dAmount);
...
<html>
    ...
    <body>
        <form action="./cardReader.jsp" method="get">
            <div class="btn-group-vertical ml-4 mt-4" role="group">
                ...
                <input class="form-control-lg" style="border-radius: 0rem; border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black; border-bottom-style: hidden;" id="stage" name="stage" value="<%= status %>" disabled>
